...
// Router cho việc thay đổi trạng thái công khai của đề thi
router.post('/exam-reading/publish/:id', verifyToken, isAdmin, readingExamController.publishExamPart);
router.post('/exam-listening/publish/:id', verifyToken, isAdmin, listeningExamController.publishExamPart);
